...
public class AdapterReferralsRv extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterReferralsRv(Context context, List<ChildHomeBean> beanList) {
        mContext = context;
        mBeanList = beanList;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_referrals_recycle,parent,false));
    }
    ...
    public class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ItemViewHolder(View itemView) {
            super(itemView);
            mCustomImageView = (CustomImageView) itemView.findViewById(R.id.civ_item_referrals_recycle);
            mCustomImageView.setType(CustomImageView.TYPE_ROUND);
            mTextView = (TextView) itemView.findViewById(R.id.tv_item_referrals_recycle);
        }
    }
